...
const (
	...
	// not in the adapter's forward chain.
	...
	// ErrMissingTransformer is returned by NewAdapter when an adjacent pair
	...
	// ErrDuplicateTransformer is returned by NewAdapter when two
