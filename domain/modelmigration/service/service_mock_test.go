...
type MockControllerStateMockRecorder struct {
	...
	getMigrationStatusExpects          []*gomock.Call2_2[context.Context, string, internal.MigrationStatusInfo, error]
...
func (m *MockControllerState) GetMigrationStatus(ctx context.Context, modelUUID string) (internal.MigrationStatusInfo, error) {
	m.ctrl.T.Helper()
	return gomock.Dispatch2_2(&m.recorder.getMigrationStatusExpects, m.ctrl, m, "GetMigrationStatus", ctx, modelUUID)
}

// GetMigrationStatus indicates an expected call of GetMigrationStatus.
func (mr *MockControllerStateMockRecorder) GetMigrationStatus(ctx, modelUUID any) *MockControllerStateGetMigrationStatusCall {
	mr.mock.ctrl.T.Helper()
	call := gomock.NewCall2_2[context.Context, string, internal.MigrationStatusInfo, error](mr.mock.ctrl.T, mr.mock, "GetMigrationStatus", gomock.EnsureMatcher(ctx), gomock.EnsureMatcher(modelUUID))
	mr.getMigrationStatusExpects = append(mr.getMigrationStatusExpects, call)
	mr.mock.ctrl.Track(call.Call)
	return call
}

// MockControllerStateGetMigrationStatusCall is the typed call wrapper for GetMigrationStatus.
type MockControllerStateGetMigrationStatusCall = gomock.Call2_2[context.Context, string, internal.MigrationStatusInfo, error]
