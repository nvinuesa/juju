...
func (m *MockK8sProvider) DesiredReplicas(name string, deploymentType k8s.WorkloadType) (int, error) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockK8sProviderDesiredReplicasCall) Do(f func(string, k8s.WorkloadType) (int, error)) *MockK8sProviderDesiredReplicasCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockK8sProviderDesiredReplicasCall) DoAndReturn(f func(string, k8s.WorkloadType) (int, error)) *MockK8sProviderDesiredReplicasCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
