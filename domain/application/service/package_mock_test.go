...
func (m *MockK8sProvider) DesiredReplicas(name string, deploymentType k8s.K8sDeploymentType) (int, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DesiredReplicas", name, deploymentType)
	ret0, _ := ret[0].(int)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockK8sProviderMockRecorder) DesiredReplicas(name, deploymentType any) *MockK8sProviderDesiredReplicasCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DesiredReplicas", reflect.TypeOf((*MockK8sProvider)(nil).DesiredReplicas), name, deploymentType)
...
// Do rewrite *gomock.Call.Do
func (c *MockK8sProviderDesiredReplicasCall) Do(f func(string, k8s.K8sDeploymentType) (int, error)) *MockK8sProviderDesiredReplicasCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockK8sProviderDesiredReplicasCall) DoAndReturn(f func(string, k8s.K8sDeploymentType) (int, error)) *MockK8sProviderDesiredReplicasCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
