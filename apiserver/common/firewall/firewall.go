...
func WatchEgressAddressesForRelations(resources facade.Resources, st State, modelConfigService ModelConfigService, applicationService ApplicationService, relations params.Entities) (params.StringsWatchResults, error) {
