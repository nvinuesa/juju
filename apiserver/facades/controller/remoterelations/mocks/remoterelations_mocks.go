...
// Source: github.com/juju/juju/apiserver/facades/controller/remoterelations (interfaces: ControllerConfigAPI,ExternalControllerService,SecretService,CrossModelRelationService)
//
// Generated by this command:
//
//	mockgen -typed -package mocks -destination mocks/remoterelations_mocks.go github.com/juju/juju/apiserver/facades/controller/remoterelations ControllerConfigAPI,ExternalControllerService,SecretService,CrossModelRelationService
//
...
func (m *MockCrossModelRelationService) WatchRemoteApplicationRelations(arg0 context.Context, arg1 string) (watcher.Watcher[[]string], error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WatchRemoteApplicationRelations", arg0, arg1)
...
func (mr *MockCrossModelRelationServiceMockRecorder) WatchRemoteApplicationRelations(arg0, arg1 any) *MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WatchRemoteApplicationRelations", reflect.TypeOf((*MockCrossModelRelationService)(nil).WatchRemoteApplicationRelations), arg0, arg1)
	return &MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall{Call: call}
}

// MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall wrap *gomock.Call
type MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall) Return(arg0 watcher.Watcher[[]string], arg1 error) *MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall) Do(f func(context.Context, string) (watcher.Watcher[[]string], error)) *MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall) DoAndReturn(f func(context.Context, string) (watcher.Watcher[[]string], error)) *MockCrossModelRelationServiceWatchRemoteApplicationRelationsCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
