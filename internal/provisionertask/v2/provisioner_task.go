...
func (t *provisionerTask) getOrCreateWorker(ctx context.Context, machineID string, machine ClassifiableMachineFull) *workerHandle {
	...
	// Create machine API adapter.
	machineAPI := &machineAPIAdapter{machine: machine}
...
// machineAPIAdapter adapts ClassifiableMachineFull to MachineAPI.
type machineAPIAdapter struct {
	machine ClassifiableMachineFull
}

func (a *machineAPIAdapter) ID() string {
	return a.machine.Id()
}

func (a *machineAPIAdapter) Life() life.Value {
	return a.machine.Life()
}

func (a *machineAPIAdapter) InstanceID() string {
...
func (a *machineAPIAdapter) KeepInstance() bool {
	keep, _ := a.machine.KeepInstance(context.Background())
	return keep
}

func (a *machineAPIAdapter) EnsureDead(ctx context.Context) error {
	return a.machine.EnsureDead(ctx)
}

func (a *machineAPIAdapter) SetStatus(ctx context.Context, st status.Status, message string) error {
	return a.machine.SetStatus(ctx, st, message, nil)
}

func (a *machineAPIAdapter) SetInstanceStatus(ctx context.Context, st status.Status, message string) error {
	return a.machine.SetInstanceStatus(ctx, st, message, nil)
}

func (a *machineAPIAdapter) MarkForRemoval(ctx context.Context) error {
