...
// Source: github.com/juju/juju/internal/bootstrap (interfaces: AgentBinaryStorage,AgentBinaryStore,ControllerCharmDeployer,HTTPClient,OperationApplier,Machine,MachineGetter,StateBackend,Application,Unit,CharmUploader,ApplicationService,ModelConfigService,Downloader,AgentPasswordService)
//
