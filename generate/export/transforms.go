...
// generated; the hand-written modelimport.go provides NewAdapter.
...
func transformDirFor(from, to string) string {
	return filepath.Join(repoRoot(), "domain", "modelimport", "adapter", "transforms",
		versionToken(from)+"_to_"+versionToken(to))
}
